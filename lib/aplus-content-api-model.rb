...
require 'aplus-content-api-model/models/content_record_list'
...
require 'aplus-content-api-model/models/get_content_document_included_data_type'
...
require 'aplus-content-api-model/models/list_content_document_asin_relations_included_data_type'
