...
# Unit tests for AmzSpApi::GetAttributesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAttributesResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::GetAttributesResponse.new
  end
  ...
  describe 'test an instance of GetAttributesResponse' do
    it 'should create an instance of GetAttributesResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::GetAttributesResponse)
    end
  end
