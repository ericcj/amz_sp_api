...
# Unit tests for AmzSpApi::CreateUploadDestinationResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateUploadDestinationResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::CreateUploadDestinationResponse.new
  end
  ...
  describe 'test an instance of CreateUploadDestinationResponse' do
    it 'should create an instance of CreateUploadDestinationResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::CreateUploadDestinationResponse)
    end
  end
