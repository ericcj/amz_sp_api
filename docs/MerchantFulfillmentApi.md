# AmzSpApi::MerchantFulfillmentApi
...
api_instance = AmzSpApi::MerchantFulfillmentApi.new
...
api_instance = AmzSpApi::MerchantFulfillmentApi.new
body = AmzSpApi::GetAdditionalSellerInputsRequest.new # GetAdditionalSellerInputsRequest | 
...
api_instance = AmzSpApi::MerchantFulfillmentApi.new
body = AmzSpApi::GetEligibleShipmentServicesRequest.new # GetEligibleShipmentServicesRequest | 
