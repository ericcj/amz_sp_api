...
# Unit tests for AmzSpApi::GetMessagingActionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMessagingActionResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::GetMessagingActionResponse.new
  end
  ...
  describe 'test an instance of GetMessagingActionResponse' do
    it 'should create an instance of GetMessagingActionResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::GetMessagingActionResponse)
    end
  end
