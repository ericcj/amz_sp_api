...
# Unit tests for AmzSpApi::GetMessagingActionResponseEmbedded
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMessagingActionResponseEmbedded' do
  before do
    # run before each test
    @instance = AmzSpApi::GetMessagingActionResponseEmbedded.new
  end
  ...
  describe 'test an instance of GetMessagingActionResponseEmbedded' do
    it 'should create an instance of GetMessagingActionResponseEmbedded' do
      expect(@instance).to be_instance_of(AmzSpApi::GetMessagingActionResponseEmbedded)
    end
  end
