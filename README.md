...
This SDK is automatically generated by running [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) on each model from https://github.com/amzn/selling-partner-api-models using the (codegen.sh) script.  Thanks to https://github.com/patterninc/muffin_man as the basis for (sp_api_client.rb)
...
Please follow the [installation](#installation) procedure and then run the following code, see (sp_configuration.rb) for all options:
```ruby
