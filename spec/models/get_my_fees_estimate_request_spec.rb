...
# Unit tests for AmzSpApi::GetMyFeesEstimateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMyFeesEstimateRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::GetMyFeesEstimateRequest.new
  end
  ...
  describe 'test an instance of GetMyFeesEstimateRequest' do
    it 'should create an instance of GetMyFeesEstimateRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::GetMyFeesEstimateRequest)
    end
  end
