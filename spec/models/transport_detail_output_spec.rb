...
# Unit tests for AmzSpApi::TransportDetailOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportDetailOutput' do
  before do
    # run before each test
    @instance = AmzSpApi::TransportDetailOutput.new
  end
  ...
  describe 'test an instance of TransportDetailOutput' do
    it 'should create an instance of TransportDetailOutput' do
      expect(@instance).to be_instance_of(AmzSpApi::TransportDetailOutput)
    end
  end
