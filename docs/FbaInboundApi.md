...
api_instance = AmzSpApi::FbaInboundApi.new
...
api_instance = AmzSpApi::FbaInboundApi.new
body = AmzSpApi::InboundShipmentRequest.new # InboundShipmentRequest | 
shipment_id = 'shipment_id_example' # String | A shipment identifier originally returned by the createInboundShipmentPlan operation.
...
api_instance = AmzSpApi::FbaInboundApi.new
body = AmzSpApi::CreateInboundShipmentPlanRequest.new # CreateInboundShipmentPlanRequest | 
...
api_instance = AmzSpApi::FbaInboundApi.new
body = AmzSpApi::PutTransportDetailsRequest.new # PutTransportDetailsRequest | 
shipment_id = 'shipment_id_example' # String | A shipment identifier originally returned by the createInboundShipmentPlan operation.
