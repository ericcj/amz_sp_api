...
# Unit tests for AmzSpApi::GetMessagingActionsForOrderResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMessagingActionsForOrderResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::GetMessagingActionsForOrderResponse.new
  end
  ...
  describe 'test an instance of GetMessagingActionsForOrderResponse' do
    it 'should create an instance of GetMessagingActionsForOrderResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::GetMessagingActionsForOrderResponse)
    end
  end
