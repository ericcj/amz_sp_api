...
# Unit tests for AmzSpApi::ReportDocumentEncryptionDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportDocumentEncryptionDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::ReportDocumentEncryptionDetails.new
  end
  ...
  describe 'test an instance of ReportDocumentEncryptionDetails' do
    it 'should create an instance of ReportDocumentEncryptionDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::ReportDocumentEncryptionDetails)
    end
  end
