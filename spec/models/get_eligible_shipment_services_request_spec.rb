...
# Unit tests for AmzSpApi::GetEligibleShipmentServicesRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEligibleShipmentServicesRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::GetEligibleShipmentServicesRequest.new
  end
  ...
  describe 'test an instance of GetEligibleShipmentServicesRequest' do
    it 'should create an instance of GetEligibleShipmentServicesRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::GetEligibleShipmentServicesRequest)
    end
  end
