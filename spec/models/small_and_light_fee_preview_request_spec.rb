...
# Unit tests for AmzSpApi::SmallAndLightFeePreviewRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmallAndLightFeePreviewRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::SmallAndLightFeePreviewRequest.new
  end
  ...
  describe 'test an instance of SmallAndLightFeePreviewRequest' do
    it 'should create an instance of SmallAndLightFeePreviewRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::SmallAndLightFeePreviewRequest)
    end
  end
