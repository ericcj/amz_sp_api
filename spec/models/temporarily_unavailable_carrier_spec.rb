...
# Unit tests for AmzSpApi::TemporarilyUnavailableCarrier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TemporarilyUnavailableCarrier' do
  before do
    # run before each test
    @instance = AmzSpApi::TemporarilyUnavailableCarrier.new
  end
  ...
  describe 'test an instance of TemporarilyUnavailableCarrier' do
    it 'should create an instance of TemporarilyUnavailableCarrier' do
      expect(@instance).to be_instance_of(AmzSpApi::TemporarilyUnavailableCarrier)
    end
  end
