...
# Unit tests for AmzSpApi::CreateFeedSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFeedSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::CreateFeedSpecification.new
  end
  ...
  describe 'test an instance of CreateFeedSpecification' do
    it 'should create an instance of CreateFeedSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::CreateFeedSpecification)
    end
  end
