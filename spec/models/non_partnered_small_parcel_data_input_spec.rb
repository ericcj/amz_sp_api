...
# Unit tests for AmzSpApi::NonPartneredSmallParcelDataInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NonPartneredSmallParcelDataInput' do
  before do
    # run before each test
    @instance = AmzSpApi::NonPartneredSmallParcelDataInput.new
  end
  ...
  describe 'test an instance of NonPartneredSmallParcelDataInput' do
    it 'should create an instance of NonPartneredSmallParcelDataInput' do
      expect(@instance).to be_instance_of(AmzSpApi::NonPartneredSmallParcelDataInput)
    end
  end
