...
# Unit tests for AmzSpApi::LabelFormatOptionRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelFormatOptionRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::LabelFormatOptionRequest.new
  end
  ...
  describe 'test an instance of LabelFormatOptionRequest' do
    it 'should create an instance of LabelFormatOptionRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::LabelFormatOptionRequest)
    end
  end
