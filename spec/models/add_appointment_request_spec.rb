...
# Unit tests for AmzSpApi::AddAppointmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddAppointmentRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::AddAppointmentRequest.new
  end
  ...
  describe 'test an instance of AddAppointmentRequest' do
    it 'should create an instance of AddAppointmentRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::AddAppointmentRequest)
    end
  end
