...
# Unit tests for AmzSpApi::RescheduleAppointmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RescheduleAppointmentRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::RescheduleAppointmentRequest.new
  end
  ...
  describe 'test an instance of RescheduleAppointmentRequest' do
    it 'should create an instance of RescheduleAppointmentRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::RescheduleAppointmentRequest)
    end
  end
