...
# Unit tests for AmzSpApi::CreateAmazonMotorsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateAmazonMotorsRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::CreateAmazonMotorsRequest.new
  end
  ...
  describe 'test an instance of CreateAmazonMotorsRequest' do
    it 'should create an instance of CreateAmazonMotorsRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::CreateAmazonMotorsRequest)
    end
  end
