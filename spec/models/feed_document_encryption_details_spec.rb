...
# Unit tests for AmzSpApi::FeedDocumentEncryptionDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeedDocumentEncryptionDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::FeedDocumentEncryptionDetails.new
  end
  ...
  describe 'test an instance of FeedDocumentEncryptionDetails' do
    it 'should create an instance of FeedDocumentEncryptionDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::FeedDocumentEncryptionDetails)
    end
  end
