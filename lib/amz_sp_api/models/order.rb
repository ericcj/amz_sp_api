...
module AmzSpApi
  ...
  class Order
    ...
    attr_accessor :assigned_ship_from_location_address
    ...
    def self.openapi_types
      {
        ...
        :'assigned_ship_from_location_address' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AmzSpApi::Order` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AmzSpApi::Order`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'assigned_ship_from_location_address')
        self.assigned_ship_from_location_address = attributes[:'assigned_ship_from_location_address']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          assigned_ship_from_location_address == o.assigned_ship_from_location_address &&
