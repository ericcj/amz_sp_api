...
# Unit tests for AmzSpApi::AmazonPrepFeesDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmazonPrepFeesDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::AmazonPrepFeesDetails.new
  end
  ...
  describe 'test an instance of AmazonPrepFeesDetails' do
    it 'should create an instance of AmazonPrepFeesDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::AmazonPrepFeesDetails)
    end
  end
