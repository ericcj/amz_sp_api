...
# Unit tests for AmzSpApi::NonPartneredSmallParcelDataOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NonPartneredSmallParcelDataOutput' do
  before do
    # run before each test
    @instance = AmzSpApi::NonPartneredSmallParcelDataOutput.new
  end
  ...
  describe 'test an instance of NonPartneredSmallParcelDataOutput' do
    it 'should create an instance of NonPartneredSmallParcelDataOutput' do
      expect(@instance).to be_instance_of(AmzSpApi::NonPartneredSmallParcelDataOutput)
    end
  end
