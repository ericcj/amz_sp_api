...
# Unit tests for AmzSpApi::NonPartneredSmallParcelPackageInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NonPartneredSmallParcelPackageInput' do
  before do
    # run before each test
    @instance = AmzSpApi::NonPartneredSmallParcelPackageInput.new
  end
  ...
  describe 'test an instance of NonPartneredSmallParcelPackageInput' do
    it 'should create an instance of NonPartneredSmallParcelPackageInput' do
      expect(@instance).to be_instance_of(AmzSpApi::NonPartneredSmallParcelPackageInput)
    end
  end
