...
# Unit tests for AmzSpApi::CreateLegalDisclosureRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateLegalDisclosureRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::CreateLegalDisclosureRequest.new
  end
  ...
  describe 'test an instance of CreateLegalDisclosureRequest' do
    it 'should create an instance of CreateLegalDisclosureRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::CreateLegalDisclosureRequest)
    end
  end
