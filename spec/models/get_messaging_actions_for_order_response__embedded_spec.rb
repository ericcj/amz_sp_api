...
# Unit tests for AmzSpApi::GetMessagingActionsForOrderResponseEmbedded
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMessagingActionsForOrderResponseEmbedded' do
  before do
    # run before each test
    @instance = AmzSpApi::GetMessagingActionsForOrderResponseEmbedded.new
  end
  ...
  describe 'test an instance of GetMessagingActionsForOrderResponseEmbedded' do
    it 'should create an instance of GetMessagingActionsForOrderResponseEmbedded' do
      expect(@instance).to be_instance_of(AmzSpApi::GetMessagingActionsForOrderResponseEmbedded)
    end
  end
